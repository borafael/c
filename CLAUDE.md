...
│   │                     #   Second "waking" world (O cycles): a lighthouse
│   │                     #   on a reflective dawn sea with a sweeping beam,
│   │                     #   driven by a live wrongness knob ([ / ]) that
│   │                     #   curdles its sky/fog/beam/sun toward the dream.
│   │                     #   Each world is its own file (world_rlyeh.c /
│   │                     #   world_lighthouse.c) behind the world_api in
│   │                     #   world.h; main.c is the shared harness.
...
./apps/rlyeh/rlyeh                       # Eerie first-person R'lyeh walk — WASD + mouse look (arrows fallback); O toggles the lighthouse "waking" world, [ / ] dial its wrongness; R res ladder, TAB CPU/GL backend, I interlace, P postfx, M mouse capture, F11 fullscreen, ESC quit (RLYEH_BENCH=1 for headless CPU bench)
